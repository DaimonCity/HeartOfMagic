...
class Spell2(Spell):
    def __init__(self, image='Wall.png'):
        super().__init__(image)
        self.speed = 1
...
class Spell2(Spell):
    ...
    def move(self, map_move, center):
        if center != None:
            self.center = center[0] - map_move[0] + self.vec[0] * 25, center[1] - map_move[1] + self.vec[1] * 25
        self.center = self.center[0] + self.vec[0] * self.speed, self.center[1] + self.vec[1] * self.speed + random.randrange(-10, 10)
        self.rect.center = self.center[0] + map_move[0], self.center[1] + map_move[1]
...
class Spell3(Spell):
    ...
    def move(self, map_move, center):
        if center != None:
            self.center = center[0] - map_move[0] + self.vec[0] * 25, center[1] - map_move[1] + self.vec[1] * 25
        self.center = self.center[0] + self.vec[0] * self.speed + math.sin(time() * 10) * 10 * self.vec[1], self.center[1] + self.vec[1] * self.speed - math.sin(time() * 10) * 10 * self.vec[0]
        self.rect.center = self.center[0] + map_move[0], self.center[1] + map_move[1]
...
class Spell4(Spell):
    ...
    def move(self, map_move, center):
        if center != None:
            self.center = center[0] - map_move[0] + self.vec[0] * 25, center[1] - map_move[1] + self.vec[1] * 25
        self.center = self.center[0] + self.vec[0] * self.speed + math.sin(time() * 10) * 10 * self.vec[1], self.center[1] + self.vec[1] * self.speed - math.cos(time() * 10) * 10 * self.vec[0]
        self.rect.center = self.center[0] + map_move[0], self.center[1] + map_move[1]
